    ...
    >
      ...
      >
        ...
        <MenuSection label={dictionary['navigation'].appsPages}>
          ...
          {/* paasport pages starts from here */}

          <MenuItem href={`/${locale}/apps/quotes`} icon={<i className='ri-file-list-line' />}>
          ...
          <MenuItem href={`/${locale}/apps/cases`} icon={<i className='ri-file-paper-line' />}>
          ...
          <SubMenu label={dictionary['navigation'].supply_chain} icon={<i className='ri-truck-line' />}>
            ...
            <MenuItem href={`/${locale}/apps/supply_chain/accounts`} icon={<i className='ri-user-settings-line' />}>
              {dictionary['navigation'].supply_chain_accounts}
            </MenuItem>
            <MenuItem href={`/${locale}/apps/supply_chain/supplier_grading`} icon={<i className='ri-star-line' />}>
              {dictionary['navigation'].supplier_grading}
            </MenuItem>
          </SubMenu>

          <MenuItem href={`/${locale}/apps/reports`} icon={<i className='ri-bar-chart-line' />}>
            {dictionary['navigation'].reports}
          </MenuItem>

          {/* paasport pages ends here */}
