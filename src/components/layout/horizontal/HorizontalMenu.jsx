  ...
  return (
    ...
    >
      ...
      >
        ...
        <MenuItem href={`/${locale}/apps/quotes`}>{dictionary['navigation'].quotes}</MenuItem>
        <MenuItem href={`/${locale}/apps/orders`}>{dictionary['navigation'].orders}</MenuItem>
        <MenuItem href={`/${locale}/apps/contacts`}>{dictionary['navigation'].contacts}</MenuItem>

      

        <MenuItem href={`/${locale}/apps/accounts`}>{dictionary['navigation'].accounts}</MenuItem>
        <MenuItem href={`/${locale}/apps/cases`}>{dictionary['navigation'].cases}</MenuItem>
        <MenuItem href={`/${locale}/apps/tasks`}>{dictionary['navigation'].tasks}</MenuItem>

        
        <SubMenu label={dictionary['navigation'].leads_managment}>
          <MenuItem href={`/${locale}/apps/leads/leads`}>{dictionary['navigation'].leads}</MenuItem>
          <MenuItem href={`/${locale}/apps/leads/research`}>{dictionary['navigation'].research}</MenuItem>
          <MenuItem href={`/${locale}/apps/leads/apollo_leads`}>{dictionary['navigation'].apollo_leads}</MenuItem>
        </SubMenu>

        <SubMenu label={dictionary['navigation'].supply_chain}>
          <MenuItem href={`/${locale}/apps/supply_chain/quotes`}>
            {dictionary['navigation'].supply_chain_quotes}
          </MenuItem>
          <MenuItem href={`/${locale}/apps/supply_chain/orders`}>
            {dictionary['navigation'].supply_chain_orders}
          </MenuItem>
          <MenuItem href={`/${locale}/apps/supply_chain/accounts`}>
            {dictionary['navigation'].supply_chain_accounts}
          </MenuItem>
          <MenuItem href={`/${locale}/apps/supply_chain/supplier_grading`}>
            {dictionary['navigation'].supplier_grading}
          </MenuItem>
        </SubMenu>
