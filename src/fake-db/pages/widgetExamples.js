  ...
  customerStats: [
    {
      color: 'primary',
      avatarIcon: 'ri-money-dollar-circle-line',
      title: 'Account Revenue YTD',
      stats: '$7480',
      content: 'Year-to-date revenue',
      description: 'Total revenue generated this year'
    },
    {
      color: 'success',
      avatarIcon: 'ri-gift-line',
      title: 'Account Revenue Lifetime',
      chipLabel: 'Platinum member',
      stats: '$58,000',
      content: 'Lifetime account revenue',
