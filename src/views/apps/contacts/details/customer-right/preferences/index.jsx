...
const preferences = () => {
  ...
  return (
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12}>
          <Checkbox checked={formData.unsubscribe} name="unsubscribe" onChange={handleChange} disabled={!isEditing} /> Unsubscribe or Do Not Email
        </Grid>
        <Grid item xs={12}>
          <Checkbox checked={formData.receiveInfo} name="receiveInfo" onChange={handleChange} disabled={!isEditing} /> I Would like to receive information from PrintForm including discounts and special offers.
        </Grid>
        <Grid item xs={6}>
          <FormControl fullWidth>
            <InputLabel>How did you hear about us?</InputLabel>
            <Select name="hearAboutUs" value={formData.hearAboutUs} onChange={handleChange} disabled={!isEditing}>
              <MenuItem value="Instagram">Instagram</MenuItem>
              <MenuItem value="LinkedIn">LinkedIn</MenuItem>
              <MenuItem value="Google">Google/Search Engines</MenuItem>
            </Select>
          </FormControl>
        </Grid>
      </Grid>
