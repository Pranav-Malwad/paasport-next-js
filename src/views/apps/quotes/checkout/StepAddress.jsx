        ...
        <div className='border rounded'>
          <CardContent className='flex flex-col gap-4'>
            ...
            <div className='flex gap-4 items-center'>
              <img width={60} height={60} src='/images/pages/dragon.png' alt='Google Home' />
              <div>
            ...
            <div className='flex gap-4 items-center'>
              <img width={60} height={60} src='/images/pages/axel.png' alt='iphone 11' />
              <div>
                <Typography>Axel</Typography>
