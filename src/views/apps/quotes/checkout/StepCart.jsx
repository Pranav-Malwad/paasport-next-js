...
const products = [
  {
    imgSrc: '/images/pages/dragon.png',
    imgAlt: 'Dragon.stl',
    productName: 'Dragon',
    inStock: true,
    Process: 'SLA',
    Material: 'ABS-Like White',
    Finish: 'Standard',
    Lead_Time: '4 Buisness Days',
    price: 299,
    originalPrice: 359,
    count: 1,
                ...
                <div className='flex flex-col gap-2 items-center sm:items-start'>
                  ...
                  <div className='flex items-center gap-4'>
                    <div className='flex items-center gap-1'>
                      <Typography color='text.disabled'>Material:</Typography>
                  ...
                  <div className='flex items-center gap-4'>
                    <div className='flex items-center gap-1'>
                      <Typography color='text.disabled'>Process:</Typography>
                      <Typography href='/' component={Link} onClick={e => e.preventDefault()} color='primary'>
                        {product.Process}
                      </Typography>
                    </div>
                  ...
                  <div className='flex items-center gap-4'>
                    <div className='flex items-center gap-1'>
                      <Typography color='text.disabled'>Finish:</Typography>
                      <Typography href='/' component={Link} onClick={e => e.preventDefault()} color='primary'>
                        {product.Finish}
                      </Typography>
                    </div>
                  ...
                  <div className='flex items-center gap-4'>
                    <div className='flex items-center gap-1'>
                      <Typography color='text.disabled'>Lead Time:</Typography>
                      <Typography href='/' component={Link} onClick={e => e.preventDefault()} color='primary'>
                        {product.Lead_Time}
                      </Typography>
                    </div>
