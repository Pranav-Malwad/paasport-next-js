...
import StepAccountDetails from './pages/auth/register-multi-steps/StepAccountDetails'
import StepPersonalInfo from './pages/auth/register-multi-steps/StepPersonalInfo'
import StepBillingDetails from './pages/auth/register-multi-steps/StepBillingDetails'
...
const RegisterMultiSteps = () => {
  ...
  return (
    <div className='flex bs-full justify-between items-center'>
      ...
      <div className='flex flex-col flex-1 justify-center items-center bs-full bg-backgroundPaper'>
        <Link
          href={getLocalizedUrl('/', locale)}
